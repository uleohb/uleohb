...
<p align="left">
  <strong>Desenvolvedor Full Stack</strong> | C# • ASP.NET Core • Razor Pages • Bootstrap • SQL Server
</p>
...
### 🧠 ProjetoTerapia
Plataforma web voltada à área da saúde mental desenvolvida com ASP.NET Core, Razor Pages, Bootstrap e SQL Server.

### ✅ GerenciadorDeTarefas--API
API REST desenvolvida em ASP.NET Core para gerenciamento de tarefas com operações CRUD.

### 🛠️ SuporTek
Sistema de suporte técnico desenvolvido com .NET MAUI, C# e SQL Server.
